...
public class Controller {
    // Each icon of the game is one Point(x, y)
    private int row;
    private int col;
    private int[][] matrix;
        ...
        do {
            ...
            if(arr[index] < max) {
                ...
                for(int j = 0; j < 2; j++) {
                    ...
                    listPoint.remove(pointIndex); // Remove field that already has value
                }
                i++;
            }
    ...
    // Algorithms to find the way between two Icons
    // 1. In the same line
    ...
    // 2. Connected by up to 3 lines within a rectangle formed from the coordinates of 2 icons
    ...
    // 3. Connected by up to 3 lines beyond the rectangle formed from the coordinates of 2 icons
